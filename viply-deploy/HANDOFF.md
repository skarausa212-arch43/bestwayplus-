...
Вкладки Inbox/Spam (+«Not spam»/«Spam»), массовое выделение (тап по аватарке)
и удаление в Trash, кнопка Sign out, «📦 Combo account» — сборка: все ящики
сессии сохраняются под именем+паролем (scrypt, /data/bundles.json), вход сборкой
на любом устройстве подгружает все почты разом.
