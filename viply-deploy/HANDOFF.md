...
- [ ] **`A mail → 185.173.144.182` — ДОБАВЛЯЛАСЬ ПОСЛЕДНЕЙ, проверить что появилась и резолвится**
      (`getent hosts mail.emailinc.info` на сервере). Без неё установщик останавливается на шаге 1/9.
...
3. Проверка: https://emailinc.info/ — лендинг EmailInc; регистрация ящика
   (инвайт-код: `emailinc-2026`); вход в /multi/; письмо самому себе.
